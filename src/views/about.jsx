...
const About = () => {
  ...
  return (
    <>
      <div
        onMouseOver={() => setText("SCROLL")}
        onMouseOut={() => setText("")}
        className="min-h-screen flex items-center justify-center px-5 pt-[65px]"
      >
        <Display className="text-center max-w-[1400px]">
          Designing & developing with passion to convey emotions through digital
          experiences
        </Display>
      </div>
      <div className="min-h-screen flex flex-col items-center justify-center px-5">
        <div className="w-full max-w-[926px] tablet:w-2/3 mobile:w-auto pb-96 grid desktop:grid-flow-col wilde:grid-flow-col tablet:grid-flow-row mobile:grid-flow-row gap-12">
          <img
            className="pt-16 desktop:sticky wilde:sticky tablet:static mobile:static desktop:w-fit top-0 w-full aspect-[10/15] object-cover"
            src="/assets/MathieuSouflis.png"
            alt="the most beautifull man (mathieu souflis)"
          />
          <div className="pt-16 flex flex-col gap-5 max-w-[453px] mobile:w-full tablet:max-w-full">
            <Body className="leading-normal text-neutral-500">
              ...
              , curious and creative, I dive into the world of development and
              design every day. Currently a student at{" "}
              <span className="font-semibold text-black">
                HETIC (2024-2027)
              </span>
              , I am pursuing a{" "}
              ...
              in Paris, where I have a strong thirst for learning. Prior to
              that, I had my{" "}
              <span className="font-semibold text-black">
                high school diploma at La Source (2022-2024)
              </span>
              .
            </Body>
            <Body className="leading-normal text-neutral-500">
              With several professional experiences under my belt, I had the
              opportunity to work as an{" "}
              <span className="font-semibold text-black">
                observer intern at Redpelicans
              </span>{" "}
              and{" "}
              <span className="font-semibold text-black underline">
                soon as a freelancer
              </span>
              . These experiences have allowed me to gain a concrete
              understanding of the challenges in the professional world while
              fostering my sense of initiative and autonomy. Every mission is an
              opportunity for me to learn and deepen my skills.
            </Body>
            <Body className="leading-normal text-neutral-500">
              Outside my passion for web development, I am a true enthusiast of{" "}
              <span className="font-semibold text-black">UI/UX design</span>,
              and I spend countless hours exploring the latest trends in the
              field. My interest in{" "}
              <span className="font-semibold text-black">innovation</span> is
              also fueled by my love for{" "}
              <span className="font-semibold text-black">music</span>: in 2024,
              I listened to over{" "}
              <span className="font-semibold text-black">
                152,000 minutes of music
              </span>
              , which allows me to escape and fuel my creativity.
            </Body>
            <Body className="leading-normal text-neutral-500">
              I am also a{" "}
              <span className="font-semibold text-black">
                big consumer of technology
              </span>
              , always on the lookout for the latest trends to stay updated and
              refine my knowledge. Finally, my language skills include{" "}
              <span className="font-semibold text-black">French (native)</span>,{" "}
              <span className="font-semibold text-black">
                English (C1 level)
              </span>
            ...
            <Body className="leading-normal text-neutral-500">
              ...
              <span className="font-semibold text-black">curiosity</span>. My
              goal is to combine these three elements to design web projects
              that are both aesthetically pleasing, functional, and
              cutting-edge.{" "}
              <span className="font-semibold text-black">
                Designing & developing with passion to create unforgettable
                digital experiences
              </span>{" "}
              is the philosophy that guides each of my projects, where every
              line of code and every design is crafted to provide an
          ...
          <div className="flex flex-col gap-52">
            <div className="flex flex-row gap-12">
              ...
              <div className="flex flex-col gap-12">
                <Header2Semibold className="uppercase">
                  Experiences
                </Header2Semibold>
                <div className="flex flex-col gap-[30px]">
                  <div className="flex flex-col gap-[10px]">
                    <Body className="uppercase text-neutral-500">
                      Freelance_._Soon/Soon
                    </Body>
                  ...
                  <div className="flex flex-col gap-[10px]">
                    <Body className="uppercase text-neutral-500">
                      Renault_Digital_._2023/2023_(2Weeks)
                    </Body>
            ...
            <div className="flex flex-row gap-12">
              ...
              <div className="flex flex-col gap-12">
                ...
                <div className="flex flex-col gap-[30px]">
                  ...
                  <div className="flex flex-col gap-[10px]">
                    <Body className="uppercase text-neutral-500">
                      I am a huge consomator
                    </Body>
                    <Body className="uppercase">Music</Body>
                    <Body className="uppercase text-neutral-500">
                      152.000_Minutes_(2024)
                    </Body>
                  </div>
                  <div className="flex flex-col gap-[10px]">
                    <Body className="uppercase text-neutral-500">
